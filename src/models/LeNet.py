...
class LeNet(tf.keras.Model):
    ...
    def search_model(lambda_l2):
        ...
        # model.add(layers.AveragePooling2D(2, strides=2))
        # model.add(layers.Flatten())
        # model.add(layers.Dense(120, activation='tanh', kernel_regularizer=regularizers.l2(lambda_l2)))
        # model.add(layers.Dense(84, activation='tanh', kernel_regularizer=regularizers.l2(lambda_l2)))
        # model.add(layers.Dense(10, activation='softmax'))
