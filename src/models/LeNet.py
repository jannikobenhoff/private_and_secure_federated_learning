...
class LeNet(tf.keras.Model):
    ...
    def search_model(lambda_l2):
        ...
        model.add(layers.Dense(120, activation='tanh', kernel_regularizer=tf.keras.regularizers.l2(lambda_l2)))
        model.add(layers.Dense(84, activation='tanh', kernel_regularizer=tf.keras.regularizers.l2(lambda_l2)))
