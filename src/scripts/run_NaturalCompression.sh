...
base_strategy='{"optimizer": "sgd", "compression": "naturalcompression", "learning_rate": 0.1}'
base_strategy_resnet='{"optimizer": "sgd", "compression": "naturalcompression", "learning_rate": 0.001}'
base_strategy_vgg11='{"optimizer": "sgd", "compression": "naturalcompression", "learning_rate": 0.01}'
