...
base_strategy='{"optimizer": "efsignsgd", "compression": "none", "learning_rate": 0.1}'
base_strategy_resnet='{"optimizer": "efsignsgd", "compression": "none", "learning_rate": 0.001}'
base_strategy_vgg11='{"optimizer": "efsignsgd", "compression": "none", "learning_rate": 0.05}'
