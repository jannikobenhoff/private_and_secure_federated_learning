...
def parse_args():
    ...
    parser.add_argument('--k_fold', type=int, help='K-Fold', default=1)
    ...
    parser.add_argument('--batch_size', type=int, help='Batch Size - if 0 -> Bach Gradient Descent, else Mini-Batch')
    parser.add_argument('--lr_drop_factor', type=float, help='Learning rate drop factor')
    parser.add_argument('--lr_drop_epochs', type=list, help='Learning rate drop epochs')
